...
It's heavily inspired by the [react-gsap](https://bitworking.github.io/react-gsap/) library for React. 
...
vue-sock just adds wrapper components/composables for these functions, so also read the official GreenSock documentation to know how to do things:
